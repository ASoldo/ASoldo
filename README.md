...
[![My Skills](https://skillicons.dev/icons?i=aws,linux,vim,neovim,bash,go,kubernetes,docker,rust,lua,markdown,html,css,alpinejs,js,ts,wasm,tailwindcss,vite,vue,nuxt,supabase,postgres,mongodb,graphql,grafana,git,github,gitlab,blender,threejs,unreal,figma,)](https://skillicons.dev)
